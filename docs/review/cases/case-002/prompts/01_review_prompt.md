...
- names embedded in email display-name forms
- names inside semi-structured text
- ambiguous phone representations
- consistency of surrogate mapping across repeated identities and simple variants
- distinction between configured paths and configured text fields
